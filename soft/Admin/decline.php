...
<html>
	...
	<body>
		...
		<div class="main">
			<h2 style="padding: 20px; padding-left: 30px; text-align: center;">Decline Device:</h2>
			<form  action="declineintodatabase.php" method="post">
				...
				<label>Reason :</label><br><input id="time" type="text" name="dreason" required /><br><br>
